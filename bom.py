...
def bom_rows():
    ...
    return [
        ...
        ("Knurled-head thumb screw, 4-40 × 1/4\", 18-8 SS — slider height lock (presses the shoe, not the post)",
         f"{thumbscrews}", "McMaster-Carr (knurled-head thumb screws)", "~$1.50 ea", "ESTIMATE"),
